...
def register_faculty():
    ...
    try:
        ...
        print("No alert. Skipping...")

def test_duplicate_faculty():
    menu = driver.find_element(By.ID, "menu") #click sidebar
    menu.click()
    time.sleep(2)
...
def create_schedule():
    ...
    number = driver.find_element(By.ID, "14") #choose the introduction to computing subject
    number.click()
    time.sleep(1)
    ...
    select_room = driver.find_element(By.ID, "room_12") #select room
    select_room.click()
    time.sleep(1)
    ...
    select_day = driver.find_element(By.ID, "name_53") #select faculty
    select_day.click()
    time.sleep(1)
